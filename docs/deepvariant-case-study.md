...
Step                               | wall time
---------------------------------- | -------------------
`make_examples`                    | 114m 44s
`call_variants`                    | 177m 24s
`postprocess_variants` (no gVCF)   | 20m 45s
`postprocess_variants` (with gVCF) | 56m 8s
total time (single machine)        | 312m 53s - 348m 16s
