...
USAGE=$'
Example usage:
inference_deeptrio_pacbio_chr20.sh --docker_build true
...
BAM_CHILD="HG002.pfda_challenge.grch38.phased.chr20.bam"
BAM_PARENT1="HG003.pfda_challenge.grch38.phased.chr20.bam"
BAM_PARENT2="HG004.pfda_challenge.grch38.phased.chr20.bam"
...
function setup_test() {
  ...
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/pacbio-case-study-testdata/HG002.pfda_challenge.grch38.phased.chr20.bam -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/pacbio-case-study-testdata/HG002.pfda_challenge.grch38.phased.chr20.bam.bai -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/pacbio-case-study-testdata/HG003.pfda_challenge.grch38.phased.chr20.bam -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/pacbio-case-study-testdata/HG003.pfda_challenge.grch38.phased.chr20.bam.bai -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/pacbio-case-study-testdata/HG004.pfda_challenge.grch38.phased.chr20.bam -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/pacbio-case-study-testdata/HG004.pfda_challenge.grch38.phased.chr20.bam.bai -d "${INPUT_DIR}"
...
function run_deeptrio() {
  ...
  /opt/deepvariant/bin/deeptrio/run_deeptrio \
    ...
    --use_hp_information=true --regions chr20 "${extra_args[@]-}" && \
