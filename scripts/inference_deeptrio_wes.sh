...
BAM_CHILD="HG002.novaseq.wes_idt.100x.dedup.bam"
BAM_PARENT1="HG003.novaseq.wes_idt.100x.dedup.bam"
BAM_PARENT2="HG004.novaseq.wes_idt.100x.dedup.bam"
...
function setup_test() {
  ...
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/exome-case-study-testdata/"${BAM_CHILD}" -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/exome-case-study-testdata/"${BAM_CHILD}".bai -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/exome-case-study-testdata/"${BAM_PARENT1}" -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/exome-case-study-testdata/"${BAM_PARENT1}".bai -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/exome-case-study-testdata/"${BAM_PARENT2}" -d "${INPUT_DIR}"
  aria2c -c -x10 -s10 http://storage.googleapis.com/deepvariant/exome-case-study-testdata/"${BAM_PARENT2}".bai -d "${INPUT_DIR}"
  ...
  aria2c -c -x10 -s10 -d "${INPUT_DIR}" "http://storage.googleapis.com/deepvariant/exome-case-study-testdata/${CAPTURE_BED}"
}
