...
ADD https://storage.googleapis.com/deepvariant/models/DeepVariant/${VERSION}/DeepVariant-inception_v3-${VERSION}-rc1+data-pacbio_standard/model.ckpt.example_info.json .
